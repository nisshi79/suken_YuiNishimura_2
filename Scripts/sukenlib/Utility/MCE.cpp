...
const int& suken::MCE::Get(Layer::LayerData layer, int x, int y)const {
	return chip[Array(layer, x, y)];
}

int suken::MCE::GetWidth()const {
	return width;
}

int suken::MCE::GetHeight()const {
	return height;
}

int suken::MCE::GetEdge()const {
	return edge;
}

std::string suken::MCE::GetGraph(Layer::LayerData layer)const {
	return graph[layer];
}
...
const int& suken::MCE::operator()(Layer::LayerData layer, int x, int y)const {
	return chip[Array(layer, x, y)];
}
